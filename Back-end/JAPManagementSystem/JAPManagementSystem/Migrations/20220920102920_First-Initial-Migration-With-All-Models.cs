...
{
    public partial class FirstInitialMigrationWithAllModels : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JapProgram", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Selections_JapProgram_JapProgramId",
                        column: x => x.JapProgramId,
                        principalTable: "JapProgram",
                        principalColumn: "Id",
